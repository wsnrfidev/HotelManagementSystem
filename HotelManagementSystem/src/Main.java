...
class Food implements Serializable
{
    ...
    Food(int itemno,int quantity)
    {
        ...
        switch(itemno)
        {
            case 1:price=quantity*20000;
                break;
            case 2:price=quantity*35000;
                break;
            case 3:price=quantity*50000;
                break;
    ...
    static void bill(int rn,int rtype)
    {
        ...
        switch(rtype)
        {
            case 1:
                ...
                break;
            case 2:amount+=300000;
                System.out.println("Room Charge - "+300000);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                ...
                break;
            case 3:amount+=280000;
                System.out.println("Room Charge - "+280000);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                ...
                break;
            case 4:amount+=170000;
                System.out.println("Room Charge - "+170000);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
